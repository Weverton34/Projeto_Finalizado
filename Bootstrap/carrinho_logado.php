    ...
    <!-- Fim -->    
		...
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a href="bolos.php">Adicionar Produtos</a>
	    	</div>
		</div>
		...
		<?php if($resultsCarts) : ?>
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinho.php?acao=del&cod=<?php echo $result['cod']?>" class="btn btn-danger">Remover</a></td>
			...
			<br/>
			<a class="botao" href="bolos.php">Continuar Comprando</a>

...
<!-- Fim Menu -->
	    ...
	    <!--Botão de Busca-->
		<div class="busca">
        <form class="form-inline" action="buscar_produto.php" method="POST"> 
       ...
       <div class="container-fluid">
          ...
          <table class="table-responsive table-bordered table-hover">
			...
			while($exibir = mysqli_fetch_assoc($query))
			{
				...
				echo "<td> <a href = 'alterar_produto.php?cod=".$cod."' class='btn btn-info'>ALTERAR</a> </td>";
				echo "<td> <a href = 'excluir_produto.php?cod=".$cod."' class='btn btn-info'>EXCLUIR</a> </td>";
				echo "</tr>";
			}
			 ?>
		...
		<!--Botão de Inserir Produtos-->
		<div class="inserir">
		    <a href= "Inserir Produtos.php" class="btn btn-info" role="button">INSERIR PRODUTO</a>
		</div>
		<!--Fim do Botão de Inserir Produtos-->
		<br/>
		<!--Footer-->
		<footer>
